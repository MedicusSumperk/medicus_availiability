...
- `/patient-lookup` searches `KAR` by phone/name/date/full `RODCIS`, asks the agent to verify identity with the last 4 digits of `RODCIS` when needed, and returns future `OBJOBJ` appointments after verification.
